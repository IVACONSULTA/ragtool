#!/usr/bin/env python3
"""
Test script for IVA Consulta agent
"""
...
async def test_iva_consulta():
    """Test the IVA Consulta agent."""
    print("🧪 Testing IVA Consulta Agent")
    print("=" * 50)
    ...
    for i, question in enumerate(test_questions, 1):
        ...
        try:
            response = await call_crewai_agent(question, "iva_consulta_agent")
